<script>
	...
	import InjectedIcon from '$lib/assets/injected.svg';
	import MetaMaskIcon from '$lib/assets/metamask.svg';
	import CoinbaseWalletIcon from '$lib/assets/coinbase.svg';
	import WalletConnectIcon from '$lib/assets/walletconnect.svg';
	import RabbyIcon from '$lib/assets/rabby.svg';
	import SafeIcon from '$lib/assets/safe.svg';
	import FrameIcon from '$lib/assets/frame.png';
	import BackpackIcon from '$lib/assets/backpack.png';
...
>
	<div class="flex flex-col items-stretch rounded p-4 gap-2">
		...
		{:else}
			<p class="text-center">No connectors found (do you have a wallet installed?)</p>
		{/each}
	</div>
</dialog>
